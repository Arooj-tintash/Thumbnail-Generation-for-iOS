...
void detect_thumbnail_frames( thumbnail_params& opt, video_metadata& meta,
                             ...
                             vector<int>& v_thumb_idx)
{
    ...
    if( nfrm_valid <= 1 ) {
        ...
        my_sort( v_shot_len, v_srt_val, v_srt_idx );
        ...
        perform_kmeans( km_data, km_lbl, km_ctr, km_k, 5 );
        ...
        my_sort( clust_sz, v_srt_val, v_srt_idx );
